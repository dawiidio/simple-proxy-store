...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  (function (global, factory) {
    ...
    var createStore = exports.createStore = function createStore(store) {
       ...
       * @private
       */
      var runSubscribers = function runSubscribers(storeObjectKey, newStore) {
      ...
      proxyStore = storeKeys.map(function (storeObjectKey) {
        ...
        var proxyDefinition = {
          set: function set(currentTarget, key, value) {
            ...
            var newProxyStore = _extends({}, proxyStore, _defineProperty({}, storeObjectKey, {
              proxy: proxyStore[storeObjectKey].proxy,
              target: currentTarget,
              newTarget: _extends({}, currentTarget, _defineProperty({}, key, value))
            }));
